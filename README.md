...
- **DPI bypass** — built-in **ByeDPI** (~47 presets) and **Zapret 2**, plus a strategy tester that
  probes several sites in parallel and shows what actually works on your ISP.
- **Manage** — diagnostics (core status, DNS, routes), Wi-Fi / LAN / DHCP, passwords and SSH keys,
  backup & maintenance, SQM / UPnP.
- **Languages** — Russian, English, Persian, Chinese. Multiple saved router profiles.
