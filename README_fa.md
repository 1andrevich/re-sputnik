...
- **مسیریابی** — حالت‌های آماده (روسیه / چین / ایران / جهانی / سفارشی) بر پایهٔ فهرست‌های Re:filter
  و Russia Inside.
...
```
UI (customtkinter)          صفحه‌های جادوگر، پیشرفت، راهنما — لایه‌ای نازک روی موتور
Orchestrator                ماشین حالت روی دستورالعمل‌های اعلانی مراحل (YAML)
SecurityGate                رضایت / منبع / لاگ — یک دروازه روی هر اجراکننده
