...
- **Маршрутизация** — готовые режимы (Россия / Китай / Иран / глобальный / свой) на списках
...
```
UI (customtkinter)          экраны мастера, прогресс, подсказки — тонкий слой над движком
Orchestrator                машина состояний над декларативными сценариями этапов (YAML)
SecurityGate                согласие / источник / лог — один шлюз над каждым исполнителем
